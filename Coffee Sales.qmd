...
```{r}
Coffee_Sales <- read.csv("../input/index_1.csv") |> 
  select(date,
         datetime,
         cash_type,
         money,
...
There are no discernible patterns, regarding which beverage will have the highest sales or orders, though there is a moderate correlation between sales increasing over time. The exception to this is how cash became a phased out type of transaction during the second quarter in 2024.
